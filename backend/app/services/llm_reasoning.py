...
from backend.app.models.retrieval import RetrievedRecipe, RetrievalRequest
...
def _build_prompt(
    ...
    *,
    ...
    prompt_lines = [
        ...
        f"Dietary restrictions / allergies: {', '.join(restrictions) if restrictions else 'None'}",
...
def generate_reasoning(
    ...
    *,
    ...
    prompt = _build_prompt(request, recipes)
    return _call_llm(
        prompt,
        provider=provider,
        model=model,
