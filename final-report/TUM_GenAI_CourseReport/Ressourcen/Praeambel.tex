...
% [H] placement keeps large screenshots from covering the heading above them.
\usepackage{float}
...
\definecolor{dishifycream}{HTML}{FFF6ED}
\definecolor{dishifyline}{HTML}{E8DFD6}
...
% Bibliography is optional for this submission. Re-enable biblatex here and
% \printbibliography in CourseReport.tex if the report later cites sources.
% \usepackage{csquotes}
